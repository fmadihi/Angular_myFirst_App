...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, ServerComponent, ServersComponent, Practice001Component, Practice002Component, TwoComponentComponent,TwoComponentComponent,DirektiveComponent,Basic_Background_highlighte_Directive,RenderBasicBackgroundHilighteDirective,StructureDirectiveComponent],
